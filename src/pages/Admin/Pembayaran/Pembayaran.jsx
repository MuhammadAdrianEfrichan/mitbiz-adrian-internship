  ...
  const handleSubmit = async (event) => {
      ...
      try {
        ...
        if (editingPembayaran) {
          await updatePembayaran(editingPembayaran.id, {
            ...payload,
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4 backdrop-blur-sm">
                        ...
                        <div className="mb-6 flex items-start justify-between gap-4">
                            ...
                            <h2 className="mt-1 text-2xl font-bold text-slate-800">
                                {editingPembayaran ? "Edit Cabang" : "Tambah Cabang Baru"}
                            </h2>
                            <p className="mt-2 text-sm text-slate-500">
                                Lengkapi data Pembayaran agar outlet Anda lebih mudah dikelola.
                            </p>
                            </div>
                            <button
                            type="button"
                        ...
                        <label className="block text-sm font-medium text-slate-700">
                            ...
                            <div className="flex justify-end gap-3 border-t border-slate-200 pt-5">
                              ...
                              >
                                {isSubmitting ? "Menyimpan..." : editingPembayaran ? "Simpan Perubahan" : "Simpan Cabang"}
                              </button>
                            </div>
                          </form>
                        </div>
