...
export const getProductsReport = (params = {}) => getReport("/reports/products/businessId", params);
export const getStocksReport = (params = {}) => getReport("/reports/stocks", params);
export const getSalesReport = (params = {}) => getReport("/reports/sales/businessId", params);
